      ...
      <div className="space-y-6">
        ...
        <Card className="p-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <h2 className="font-semibold">Votre site</h2>
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/editor"
                className="inline-flex items-center gap-1.5 rounded-full bg-primary-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-primary-600"
              >
                ✎ Éditer mon site
              </Link>
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-full border border-primary-200 bg-white/60 px-4 py-2.5 text-sm font-medium text-primary-700 transition-colors hover:border-primary-300 hover:bg-primary-50"
              >
                ↗ Voir
              </a>
            </div>
        ...
        {blog ? (
          <Card className="p-5">
            <div className="flex items-center justify-between gap-2">
              <h2 className="font-semibold">Prochaines publications</h2>
              <Link href="/publications" className="text-xs font-medium text-primary-700 hover:underline">
                Tout l&apos;agenda →
              </Link>
            </div>
            {upcoming.length > 0 ? (
              <ul className="mt-4 space-y-3">
                {upcoming.map((item) => (
                  <li key={`${item.date}-${item.title}`} className="flex items-start gap-2.5">
                    <span
                      aria-hidden
                      className="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-primary-400"
                    />
