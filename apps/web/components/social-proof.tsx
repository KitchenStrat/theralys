...
const NOTES = [
  {
    ...
    text: "Résultat pro et moderne, interface simple a prendre en main",
  ...
  },
  {
    ...
    role: "Ostéopathe",
    title: "Je recommande",
    text: "Fonctionnel et intuitif, un vrai plus pour la prise de rdv !",
  ...
  },
  {
    ...
    title: "Tres pro",
    text: "Démo reçue en quelques jours, site en ligne la semaine suivante. Nickel",
