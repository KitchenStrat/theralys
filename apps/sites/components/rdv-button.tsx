...
export function RdvButton({
  ...
  return (
    <a
      ...
      className={
        className ??
        "inline-flex items-center justify-center rounded-full bg-[var(--site-primary)] px-6 py-3 font-medium text-white transition-colors hover:bg-[var(--site-primary-dark)]"
      }
    >
      {label}
    </a>
