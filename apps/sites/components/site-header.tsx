  ...
  return (
    <header className="sticky top-0 z-40 border-b border-black/5 bg-[var(--site-bg)]/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
        ...
        <nav aria-label="Navigation principale" className="hidden items-center gap-5 text-sm lg:flex">
          {motifPages.length > 0 ? (
        ...
        <RdvButton
          ...
          className="hidden shrink-0 items-center justify-center rounded-full bg-[var(--site-primary)] px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[var(--site-primary-dark)] sm:inline-flex"
        />
      </div>
    </header>
  );
